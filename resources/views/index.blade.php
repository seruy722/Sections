...
@section('content')
    <!-- Sections -->
    <div id="sections" class="sections ha-waypoint" data-animate-down="ha-header-small" data-animate-up="ha-header-large">
        <div class="container">
            <div class="row">
                                ...
                                <li class="events-group">
                                    ...
                                    <ul>
                                        ...
                                        <li class="single-event" data-start="11:30" data-end="13:00" data-content="event-restorative-yoga" data-event="event-4">
                                            <a href="#0"><em class="event-name">Restorative Yoga</em></a>
                                        </li>
                        ...
                        <div class="imgSwitch">
                            <div class="row">
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt graphic">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Blue Gate" src="images/img1.jpg"></div>
                                            <div class="itemInfo">
                                                <h4>The Blue Gate</h4>
                                                <h6>Graphic</h6>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt webdesign">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Womens Stone" src="images/img2.jpg"></div>
                                            <div class="itemInfo">
                                                <h4>Women's Stone</h4>
                                                <h6>Webdesign</h6>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt creative">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Elves Past" src="images/img3.jpg"></div>
                                            <div class="itemInfo">
                                                <h4>Elves of Past</h4>
                                                <h6>Creative</h6>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt inspiration">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Silken Wife" src="images/img4.jpg"></div>
                                            <div class="itemInfo">
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt webdesign">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Some Vision" src="images/img5.jpg"></div>
                                            <div class="itemInfo">
                                                <h4>Some Vision</h4>
                                                <h6>Webdesign</h6>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt inspiration">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Snow Woman" src="images/img6.jpg"></div>
                                            <div class="itemInfo">
                                                <h4>Snow of Woman</h4>
                                                <h6>Inspiration</h6>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt graphic">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Mist Witches" src="images/img7.jpg"></div>
                                            <div class="itemInfo">
                                                <h4>Mist Witches</h4>
                                                <h6>Graphic</h6>
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 dbox-list prod-cnt creative">
                                    <div class="itemCont">
                                        <a href="#">
                                            <div class="thumb"><img class="img-responsive center-block" alt="Wind of Worlds" src="images/img8.jpg"></div>
                                            <div class="itemInfo">
